...
public class ClsOscilloscope	//示波器类
{
    ...
    class RecordThread extends Thread//录音线程
    {
    ...
    class DrawThread extends Thread	//绘制线程
    {
	...
	void SimpleDraw(int start, short[] buffer, int rate, int baseLine)
	{
	    ...
	    Canvas canvas = sfv.getHolder().lockCanvas();// 获取画布
